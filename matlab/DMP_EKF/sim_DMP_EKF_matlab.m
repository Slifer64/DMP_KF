...
%% Set up EKF object
ekf = extendedKalmanFilter(@stateTransFun, @msrFun, theta, 'HasAdditiveMeasurementNoise',true);
ekf.State = theta;
...
while (true)
    ...
    for i=1:Dim  
        ...
        dC_dtheta_i = dmp{i}.getAcellPartDev_g_tau(t, Y_hat(i), dY_hat(i), Y0(i), x_hat, Yg_hat(i), tau_hat);
...
function y_out = hmeas(theta, cookie)
