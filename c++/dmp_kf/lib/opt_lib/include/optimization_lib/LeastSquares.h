...
#ifndef LEAST_SQUARES_LEARNING_H
#define LEAST_SQUARES_LEARNING_H
 ...
 */
arma::mat normKernelLS(const arma::mat &Psi, const arma::mat &X, const arma::rowvec &Fd, double zero_tol=0.0);


/** \brief Recursive Least Squares kernel based learning
*/
