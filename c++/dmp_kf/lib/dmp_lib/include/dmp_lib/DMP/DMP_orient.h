...
#ifndef ORIENTATION_DYNAMICAL_MOVEMENT_PRIMITIVE_H
#define ORIENTATION_DYNAMICAL_MOVEMENT_PRIMITIVE_H
...
public:
   ...
   */
  DMP_orient(std::vector<std::shared_ptr<DMP_>> &vec3D_dmp);
  ...
  */
   ...
   */
  arma::vec forcingTermScaling(const arma::vec &Q0, const arma::vec &Qg) const;
   ...
   */
  arma::vec goalAttractor(const arma::vec &X, const arma::vec &Q, const arma::vec &eta, const arma::vec &Qg) const;
   ...
   */
  arma::vec shapeAttractor(const arma::vec &X, const arma::vec &Q0, const arma::vec &Qg) const;
  ...
  arma::vec phaseDot(const arma::vec &X) const;

}; // class DMP_orient

} // namespace as64_

#endif // ORIENTATION_DYNAMICAL_MOVEMENT_PRIMITIVE_H
